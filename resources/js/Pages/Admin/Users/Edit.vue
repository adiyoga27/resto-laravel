...
<template>
    <div class="mx-auto max-w-2xl">
        <PageHeader title="Edit User" :subtitle="`Memperbarui akun ${user.name}`" />
        <form class="card space-y-5 p-6" @submit.prevent="submit">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <FormGroup name="password" label="Password Baru" :error="form.errors.password" hint="Kosongkan jika tidak ingin mengganti password">
            ...
            <FormToggle v-model="form.is_active" name="is_active" label="Akun Aktif" />
