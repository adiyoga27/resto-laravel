                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-v1-profile">GET api/v1/profile</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-menu">
                                <a href="#endpoints-GETapi-v1-menu">GET api/v1/menu</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-menu--menuItem_id-">
                                <a href="#endpoints-GETapi-v1-menu--menuItem_id-">GET api/v1/menu/{menuItem_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-reservations">
                                <a href="#endpoints-GETapi-v1-reservations">GET api/v1/reservations</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-reservations">
                                <a href="#endpoints-POSTapi-v1-reservations">POST api/v1/reservations</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-reservations--reservation_id-">
                                <a href="#endpoints-GETapi-v1-reservations--reservation_id-">GET api/v1/reservations/{reservation_id}</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-v1-orders">GET api/v1/orders</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-orders--order_id-">
                                <a href="#endpoints-GETapi-v1-orders--order_id-">GET api/v1/orders/{order_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-payments-callback">
                                <a href="#endpoints-POSTapi-v1-payments-callback">POST api/v1/payments/callback</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-payments--payment_id-">
                                <a href="#endpoints-GETapi-v1-payments--payment_id-">GET api/v1/payments/{payment_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-sync">
                                <a href="#endpoints-POSTapi-v1-sync">POST api/v1/sync</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-menu">GET api/v1/menu</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-menu--menuItem_id-">GET api/v1/menu/{menuItem_id}</h2>
...
<p>The ID of the menuItem. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-reservations">GET api/v1/reservations</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-reservations">POST api/v1/reservations</h2>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"restaurant_table_id\": \"architecto\",
    \"reservation_time\": \"2052-08-29\",
    \"guest_count\": 22,
    \"notes\": \"g\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="restaurant_table_id"                data-endpoint="POSTapi-v1-reservations"
               value="architecto"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>now</code>. Example: <code>2052-08-29</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Must not be greater than 500 characters. Example: <code>g</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-reservations--reservation_id-">GET api/v1/reservations/{reservation_id}</h2>
...
<div class="bash-example">
    ...
    \"delivery_address\": \"n\",
    \"customer_name\": \"g\",
    \"customer_phone\": \"zmiyvdljnikhwayk\"
}"
</code></pre></div>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>delivery</code></li> <li><code>pickup</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
        <details>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>This field is required when <code>order_type</code> is <code>delivery</code>. Must not be greater than 500 characters. Example: <code>n</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-orders--order_id-">GET api/v1/orders/{order_id}</h2>
...
<p>The ID of the order. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-payments-callback">POST api/v1/payments/callback</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="order_id"                data-endpoint="POSTapi-v1-payments-callback"
               value="architecto"
               data-component="body">
    <br>
<p>Must match an existing stored value. Example: <code>architecto</code></p>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>cash</code></li> <li><code>qris</code></li> <li><code>transfer</code></li> <li><code>card</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="amount"                data-endpoint="POSTapi-v1-payments-callback"
               value="39"
               data-component="body">
    <br>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-payments--payment_id-">GET api/v1/payments/{payment_id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/payments/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the payment. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-sync">POST api/v1/sync</h2>
